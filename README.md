...
* `./urandom.sh`: This script will add a line at the end of .bashrc that will display random characters each time the victim opens his terminal. *this only edit .bashrc so you need to be aware of which shell your victim uses*
